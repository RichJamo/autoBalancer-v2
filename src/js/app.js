...
async function startApp(provider) {
  ...
  withdrawToUserButton.addEventListener('click', async () => {
    ...
    await dappContract_signer.withdrawUserFunds(user, WMATIC_share, SUSHI_share, WETH_share, WBTC_share)
...
async function withdrawUserShareFromBentoBoxToDapp(token_address, user_share) { 
  try {
